...
main (void)
{
  ...
  my_filename_stream << "test_stream" << j << ".out";
  ...
  my_filename_stream.str ("");  // clear the string stream
  float alpha = 5.21934;    // more digits than we plan to use
  my_filename_stream << "pedulum_alpha" << setprecision (3) << alpha
                     << "_plot"<< ".dat";
