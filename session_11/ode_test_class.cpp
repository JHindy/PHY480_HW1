...
main ()
{
  ...
  evolve_and_print(vdp_ode_1, vdp_rhs_1, x1, v1, tmin, tmax, delta_t);
  evolve_and_print(vdp_ode_1, vdp_rhs_1, x2, v2, tmin, tmax, delta_t);

  evolve_and_print(vdp_ode_2, vdp_rhs_2, x0, v0, tmin, tmax, delta_t);
  evolve_and_print(vdp_ode_2, vdp_rhs_2, x1, v1, tmin, tmax, delta_t);
  evolve_and_print(vdp_ode_2, vdp_rhs_2, x2, v2, tmin, tmax, delta_t);
