...
main (void)
{
  ...
  params_ptr = &my_coefficients;		// double to pass to function 
  ...
  out << "h                 forward           central           extrapolated central" << endl;   
...
test_function (double x, void *params_ptr)
{
  ...
  double alpha = passed_ptr->a;
  double beta = passed_ptr->b;
